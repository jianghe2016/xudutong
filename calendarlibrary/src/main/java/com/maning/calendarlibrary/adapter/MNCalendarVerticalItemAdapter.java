...
public class MNCalendarVerticalItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MNCalendarVerticalItemAdapter(Context context, ArrayList<MNCalendarItemModel> mDatas, Calendar currentCalendar, MNCalendarVerticalAdapter adapter, MNCalendarVerticalConfig mnCalendarVerticalConfig) {
        ...
        Log.d("now_yyy_mm_ddnow_yyy_m",now_yyy_mm_dd+"");//2018-03-07
        try {
            nowDate = MNConst.sdf_yyy_MM_dd.parse(now_yyy_mm_dd);
            Log.d("nowDatenowDate",nowDate+"");// Wed Mar 07 00:00:00 GMT+08:00 2018
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (now_yyy_mm_dd.equals(position_yyy_MM_dd)) {
                ...
                //新加代码
                myViewHolder.tvDay.setTextColor(Color.parseColor("#282828"));
            }
            //大于今天的颜色变灰
            if (datePosition.getTime() > nowDate.getTime()+1000*60*60*24) {
            ...
            if (adapter.startDate != null && adapter.startDate == datePosition) {
                ...
                myViewHolder.tvDay.setTextColor(mnCalendarVerticalConfig.getMnCalendar_colorStartAndEndtext());
                myViewHolder.tv_small.setTextColor(mnCalendarVerticalConfig.getMnCalendar_colorStartAndEndtext());
                //动态修改颜色
            ...
            myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //必须小于今天
                    if (dateClick.getTime() > nowDate.getTime()+1000*60*60*24) {
                        Log.e("dateClick=========",dateClick.getTime()+"");
                        Log.e("nowDate=========",nowDate.getTime()+"");
                        Toast.makeText(context, "选择的日期必须小于今天", Toast.LENGTH_SHORT).show();
                        return;
                    }
