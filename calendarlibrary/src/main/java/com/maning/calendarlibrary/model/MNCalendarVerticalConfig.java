...
public class MNCalendarVerticalConfig {
    ...
    //开始结束的背景颜色
    private int mnCalendar_colorStartAndEndBg = Color.parseColor("#17a0f1");
    //开始结束的字体颜色
    private int mnCalendar_colorStartAndEndtext = Color.parseColor("#ffffff");
    //区间中间的背景颜色
    private int mnCalendar_colorRangeBg = Color.parseColor("#ffffff");
    //区间文字的颜色
    ...
    public int getMnCalendar_colorStartAndEndtext() {
        return mnCalendar_colorStartAndEndtext;
    }

    private void setMnCalendar_colorStartAndEndtext(int mnCalendar_colorStartAndEndtext) {
        this.mnCalendar_colorStartAndEndtext = mnCalendar_colorStartAndEndtext;
    }
