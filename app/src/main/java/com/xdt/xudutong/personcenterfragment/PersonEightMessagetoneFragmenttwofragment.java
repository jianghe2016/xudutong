...
public class PersonEightMessagetoneFragmenttwofragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.person_eight_messageone_fragment_twofragment, container, false);
        initView();
        initData();
        return view;
    }
    ...
    private void initView() {
        mperson_eight_messageone_fragment_onefragmentrecycleview = (XRecyclerView) view.findViewById(R.id.person_eight_messageone_fragment_twofragmentrecycleview);
