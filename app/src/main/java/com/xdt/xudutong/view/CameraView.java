...
import com.xdt.xudutong.utils.CameraThreadPool;
import com.xdt.xudutong.utils.DimensionUtil;
import com.xdt.xudutong.utils.ImageUtilCamera;
...
public class CameraView extends FrameLayout {
    ...
    private int detect(byte[] data, final int rotation) {
        ...
        options.inSampleSize = ImageUtilCamera.calculateInSampleSize(options, size, size);
    ...
    private class CameraViewTakePictureCallback implements ICameraControl.OnTakePictureCallback {
        ...
        public void onPictureTaken(final byte[] data) {
            CameraThreadPool.execute(new Runnable() {
                @Override
                public void run() {
                    final int rotation = ImageUtilCamera.getOrientation(data);
