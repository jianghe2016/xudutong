...
public class WeatnerChartViewtwo extends View {
    ...
    public WeatnerChartViewtwo(Context ct) {
        super(ct);
        this.context = ct;
    }

    public WeatnerChartViewtwo(Context ct, AttributeSet attrs) {
        super(ct, attrs);
        this.context = ct;
    }

    public WeatnerChartViewtwo(Context ct, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#7fffffff"));//#7fffffff
        ...
        for (int i = 0; i < mPoints.length; i++) {
            canvas.drawCircle(mPoints[i].x, mPoints[i].y, 5, paint);//radius=12
