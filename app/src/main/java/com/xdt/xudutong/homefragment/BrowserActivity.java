...
public class BrowserActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // urll = intent.getStringExtra(CodeUtils.RESULT_STRING);
        ...
        if (TextUtils.isEmpty(jpush_topviewtext)) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    PendingIntent pendingIntent = PendingIntent.getActivity
                            //通过Notification来创建通知
                                    (BrowserActivity.this, 1, new Intent(BrowserActivity.this, SplashActivity.class), 0);
                    builder.setContentIntent(pendingIntent);
                    NotificationManager manager = (NotificationManager) getSystemService
                            (NOTIFICATION_SERVICE);
                    manager.notify(5, builder.build());//通过管理器发起通知
                    System.out.println("X5浏览器下载:" + msg.arg1);
    ...
    private class MyWebViewDownLoadListener implements DownloadListener {
        ...
        public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype,
            ...
            new InstallUtils(context, url, APK_NAME, new InstallUtils.DownloadCallBack() {
                @Override
                public void onStart() {
                    LogUtil.d(TAG, "InstallUtils---onStart");

                }

                @Override
                public void onComplete(String path) {
                    LogUtil.d(TAG, "InstallUtils---onComplete:" + path);
                    InstallUtils.installAPK(context, path, getPackageName() + ".fileProvider", new InstallUtils.InstallCallBack() {
                        @Override
                        public void onSuccess() {
                            ToastUtils.getInstance(context).showMessage("正在安装程序");
                    }

                        @Override
                        public void onFail(Exception e) {
                            ToastUtils.getInstance(context).showMessage("安装失败");
                        }
                    });
                ...
                public void onLoading(long total, long current) {
                    LogUtil.d(TAG, "InstallUtils----onLoading:-----total:" + total + ",current:" + current);
                ...
                @Override
                public void onFail(Exception e) {
                    LogUtil.d(TAG, "InstallUtils---onFail:" + e.getMessage());
                }
