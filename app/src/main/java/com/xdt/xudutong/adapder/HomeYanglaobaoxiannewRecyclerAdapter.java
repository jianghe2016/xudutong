 ...
 */
public class HomeYanglaobaoxiannewRecyclerAdapter extends RecyclerView.Adapter<HomeYanglaobaoxiannewRecyclerAdapter.MyHolder> implements View.OnClickListener {

    private List<DsepgetEndowmentInsurance.ContentBean.DataBean> dsepgetendowmentinsurancedata;
    private String[] gongjijintext2;
    private Context context;
    private LayoutInflater inflater;

    public HomeYanglaobaoxiannewRecyclerAdapter(Context context, List<DsepgetEndowmentInsurance.ContentBean.DataBean> dsepgetendowmentinsurancedata, String[] gongjijintext2) {
        this.context = context;
        this.dsepgetendowmentinsurancedata = dsepgetendowmentinsurancedata;
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.item2.setText(dsepgetendowmentinsurancedata.get(position).getCardNum());
        holder.item3.setText(gongjijintext2[1]);
        holder.item4.setText(dsepgetendowmentinsurancedata.get(position).getInsureType());
        holder.item5.setVisibility(View.GONE);
        holder.item6.setVisibility(View.GONE);
        holder.item7.setText(gongjijintext2[2]);
        holder.item8.setText(dsepgetendowmentinsurancedata.get(position).getFirstPayDate());
        holder.item9.setText(gongjijintext2[3]);
        holder.item10.setText(dsepgetendowmentinsurancedata.get(position).getGiveBDate());
    ...
    public int getItemCount() {
        return dsepgetendowmentinsurancedata.size();
    }
