 ...
 */
public class TopRecyclerAdapter extends RecyclerView.Adapter<TopRecyclerAdapter.MyHolder> implements View.OnClickListener {

    private List<HujidifindHujidis.ContentBean.DataBean> hujidifindhujidisdata;
    private Context context;
    private LayoutInflater inflater;

    public TopRecyclerAdapter(Context context,List<HujidifindHujidis.ContentBean.DataBean> hujidifindhujidisdata) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.toprecycleview_item, parent, false);
    ...
    public int getItemCount() {
     ...
     class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View view) {
            super(view);
            itemone = (TextView) view.findViewById(R.id.topitem1);
