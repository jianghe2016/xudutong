 ...
 */
public class ProductRecyclerAdapterone extends RecyclerView.Adapter<ProductRecyclerAdapterone.MyHolder> implements View.OnClickListener {

    private List list;
    private Context context;
    private LayoutInflater inflater;

    public ProductRecyclerAdapterone(Context context, List list) {
