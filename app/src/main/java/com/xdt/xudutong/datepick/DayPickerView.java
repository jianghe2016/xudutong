...
public class DayPickerView extends RecyclerView {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int firstItemHeight = getChildAt(0).getMeasuredHeight();
        if (getMeasuredHeight() != firstItemHeight) {
            getLayoutParams().height = firstItemHeight;
            requestLayout();
        }
    }
    ...
    public HashMap<String, SimpleMonthAdapter.CalendarDay> getSelectedDays() {
        return mAdapter.getSelectedDays();
    }

    public void setSelectedDays(HashMap<String, SimpleMonthAdapter.CalendarDay> selectedDays) {
        mAdapter.setSelectedDay(selectedDays);

    }

    public void clearSelectedDays() {
        mAdapter.clearSelectDay();
    }

    public void setCountMap(List<SimpleMonthAdapter.CalendarDay> countMap) {
